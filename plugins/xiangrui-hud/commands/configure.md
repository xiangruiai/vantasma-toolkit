...
# Configure xiangrui-hud

**FIRST**: Use the Read tool to load `~/.claude/plugins/xiangrui-hud/config.json` if it exists.
...
Write to `~/.claude/plugins/xiangrui-hud/config.json`.
