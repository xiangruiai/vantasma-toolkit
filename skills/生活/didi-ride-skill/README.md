...
```bash
zsh <(curl -fsSL "https://raw.githubusercontent.com/xiangruiai/xiangrui-toolkit/main/skills/生活/didi-ride-skill/install.sh")
```
...
zsh "xiangrui-toolkit/skills/生活/didi-ride-skill/install.sh"
```
...
这个项目永久免费使用。如果它帮到了你，欢迎[请祥瑞喝杯咖啡](https://pay.xiangruiai.com/?project=didi-ride)，鼓励他继续维护并开源更多实用工具。赞赏完全自愿，不解锁任何功能。
