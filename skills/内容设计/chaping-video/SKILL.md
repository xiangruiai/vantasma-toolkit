...
- **时长由内容决定，不硬卡（祥瑞 2026-06-11 定）**：能讲清主题的最短时长就是它该有的长度——
  单一概念/速报 60-90 秒（≈350-550 字）；多个点+演示 90 秒-2 分钟；需要层层铺垫论证的复杂主题
  2-3 分钟也行。**红线是不注水**：每句都要有信息增量，宁可 3 分钟密度高，不要 90 秒硬塞或为凑时长注水。
  研究后先数"这主题有几个必讲的点"，点多就长、点少就短，但每个点都要够硬。这是"具体情况具体分析"在时长上的延伸
